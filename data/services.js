export const services = [
  {
    ...
    description: `Complete email migration service between providers with all historical data.
...
📌 Perfect for: Businesses changing email providers or hosting`,
  ...
  },
  {
    ...
    description: `Professional setup of Google Workspace for seamless business communication.
...
🚀 Impact: Professional image with reliable communication infrastructure`,
  ...
  },
  {
    ...
    description: `Professional configuration of Microsoft Office 365 for your business needs.
...
🚀 Impact: Enhanced productivity with familiar tools in a cloud environment`,
  ...
  },
  {
    ...
    shortDescription:
      "Fix SPF, DKIM, DMARC, MX and all DNS records for better email deliverability",
    description: `Professional DNS management for optimal email delivery and website performance.
...
🚀 Impact: Improved deliverability and reduced downtime for critical business operations`,
  ...
  },
  {
    ...
    description: `Professional domain transfer service to move your domain to a better registrar.
...
📌 Perfect for: Businesses wanting better domain control or pricing`,
  ...
  },
  {
    ...
    description: `Expert WordPress website migration to new hosting with all functionality intact.
...
📌 Perfect for: WordPress sites needing better hosting performance`,
  ...
  },
  {
    title: "Figma to HTML",
    slug: "figma-to-html",
    shortDescription: "Convert your Figma design into responsive code",
    description: `Convert your Figma designs into clean, responsive HTML/CSS/JavaScript code that works perfectly across all devices.
...
🚀 Impact: Faster time-to-market with a website that looks professional on any device`,
  ...
  },
  {
    ...
    shortDescription: "High-performance site using React & Next.js",
    description: `Build high-performance web applications with React & Next.js for superior speed and SEO.
...
🚀 Impact: Higher conversion rates with improved page speed and search visibility`,
  ...
  },
  {
    ...
    shortDescription: "Boost loading speed for SEO and UX",
    description: `Improve page speed and performance for better SEO & user experience.
...
🚀 Impact: Higher search rankings and better user engagement metrics`,
  ...
  },
  {
    ...
    description: `Professional migration of all emails, contacts, and calendars from Outlook to Google Workspace.
...
🚀 Impact: Improved team productivity with seamless access to Gmail, Drive, and Meet`,
  ...
  },
  {
    ...
    description: `Expert domain migration between registrars with proper DNS configuration.
