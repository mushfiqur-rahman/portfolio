export const services = [
  ...
  },
  {
    ...
    shortDescription:
      "Beautiful, professional Squarespace websites that convert",
    description: [
      "Custom Squarespace websites designed for your brand with e-commerce capabilities.",
      "✅ Custom template design",
      "✅ Mobile-optimized layout",
      "✅ SEO-friendly structure",
      "✅ E-commerce integration",
      "✅ Content management training",
      "💡 Benefit: Stunning website without technical headaches",
      "🚀 Impact: Professional online presence that builds trust and credibility",
      "📌 Perfect for: Creatives, small businesses, portfolio sites",
    ].join("\n"),
    image: "/services/squarespace-design.png",
  },
  {
    title: "Squarespace SEO Optimization",
    slug: "squarespace-seo",
    shortDescription: "Boost your Squarespace site's search rankings",
    description: [
      "Comprehensive SEO optimization for Squarespace websites.",
      "✅ Technical SEO audit",
      "✅ Keyword optimization",
      "✅ Schema markup implementation",
      "✅ Image optimization",
      "✅ Speed enhancements",
      "💡 Benefit: Get found by more potential customers",
      "🚀 Impact: Increased organic traffic and lead generation",
      "📌 Perfect for: Existing Squarespace sites needing more visibility",
    ].join("\n"),
    image: "/services/squarespace-seo.png",
  },
  {
  ...
  {
    title: "Squarespace to WordPress Migration",
    slug: "squarespace-to-wordpress",
    shortDescription: "Seamless transition to WordPress with no data loss",
    description: [
      "Professional migration from Squarespace to WordPress with design preservation.",
      "✅ Complete content transfer",
      "✅ URL redirect setup",
      "✅ Design matching",
      "✅ SEO preservation",
      "✅ Training provided",
      "💡 Benefit: WordPress flexibility without losing your existing content",
      "🚀 Impact: More control over your website with powerful WordPress features",
      "📌 Perfect for: Outgrowing Squarespace's limitations",
    ].join("\n"),
    image: "/services/squarespace-migration.png",
  },
];
