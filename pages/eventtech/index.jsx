...
const index = () => {
  return (
    <>
      <Head>
        <title>Eventtechbd - project</title>
        <link rel="canonical" href="/eventtech" />
        <meta
          name="description"
          content="This was first project which is developed for a startup company based in jessore khulna bangladesh"
        />
        <meta
          name="keywords"
