...
import huluImg from "../public/projects/hulu.webp";
    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <a
            href="https://github.com/mushfiqur-rahman/hulu"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://hulu-mushfiqdev.vercel.app/"
            target="_blank"
            rel="noreferrer"
          >
