      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <p>
            ...
            django after that I showed it using DRF then used those api in React
            mui autocomplete. I made a video on it also for better
            understanding.
          </p>
          {/* <a
            href="https://github.com/mushfiqur-rahman/google_spreadhseetapi_mui_autocomplete"
            target="_blank"
            rel="noreferrer"
          >
