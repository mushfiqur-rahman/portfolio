    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            I built this application in Django and PostgreSQL. It has pagination
            with infinite scroll, serach option, markdown post format, Tag wise
            view etc I tested this project using pytest and host it render.com
            as a free.
          </p>
          <a
